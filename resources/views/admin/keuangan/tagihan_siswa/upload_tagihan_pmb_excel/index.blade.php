...
@section('style')
    ...
    <style>
        .upload-tagihan-toolbar .form-label { margin-bottom: 0.35rem; font-size: 0.8125rem; font-weight: 600; }
        .upload-tagihan-toolbar .select2-container { width: 100% !important; }
        .upload-tagihan-preview { display: inline-flex; align-items: center; gap: 0.35rem; margin-top: 0.5rem; font-size: 0.8125rem; color: var(--bs-secondary-color); }
